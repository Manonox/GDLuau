...
void LuauVM::_bind_passthrough_methods() {
    ...
    // Constants
    {
        ...
        // Libraries
        BIND_ENUM_CONSTANT(LUA_LIB_BASE);
        BIND_ENUM_CONSTANT(LUA_LIB_COROUTINE);
        BIND_ENUM_CONSTANT(LUA_LIB_TABLE);
        BIND_ENUM_CONSTANT(LUA_LIB_OS);
        BIND_ENUM_CONSTANT(LUA_LIB_STRING);
        BIND_ENUM_CONSTANT(LUA_LIB_MATH);
        BIND_ENUM_CONSTANT(LUA_LIB_VECTOR);
        BIND_ENUM_CONSTANT(LUA_LIB_DEBUG);
        BIND_ENUM_CONSTANT(LUA_LIB_UTF8);
        BIND_ENUM_CONSTANT(LUA_LIB_BIT32);
